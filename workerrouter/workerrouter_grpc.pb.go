...
func (x *workerRouterPullClient) Send(m *TaskComplete) error {
...
func (x *workerRouterPullServer) Recv() (*TaskComplete, error) {
	m := new(TaskComplete)
